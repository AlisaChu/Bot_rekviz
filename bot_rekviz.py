...
Для оплаты взноса из ЕС напишите в боте слово "iban", вышлем реквизиты отдельно.

Если вы не знаете, как оплатить участие из РБ, напишите в боте слово "Беларусь", вышлем информацию по способам оплаты.
